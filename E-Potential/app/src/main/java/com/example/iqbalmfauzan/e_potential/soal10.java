...
public class soal10 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.soal1a:
                ...
                Intent soal2 = new Intent(getApplicationContext(), score.class);
                startActivity(soal2);
                finish();
                break;
            case R.id.soal1b:
                salah.setVisibility(View.VISIBLE);
                Intent soal2a = new Intent(getApplicationContext(), score.class);
                startActivity(soal2a);
                finish();
                break;
            case R.id.soal1c:
                benar.setVisibility(View.VISIBLE);
                Intent soal2b = new Intent(getApplicationContext(), score.class);
                startActivity(soal2b);
                finish();
                break;
            case R.id.soal1d:
                salah.setVisibility(View.VISIBLE);
                Intent soal2c = new Intent(getApplicationContext(), score.class);
